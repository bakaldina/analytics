...
var m_chartdiv1 = AmCharts.makeChart("chartdiv1", {
  type: "serial",
  addClassNames: true,
  theme: "light",
  autoMargins: false,
...
var m_chartdiv = AmCharts.makeChart("chartdiv",
  {
    "type": "serial",
    ...
    "graphs": [
      {
        "balloonText": "[[title]] в [[category]] г.: [[value]]%",
        "fillAlphas": 1,
        "id": "AmGraph-1",
        "tabIndex": 5,
    ...
    "titles": [
      {
        ...
        "size": 12,
        "tabIndex": 0,
        "text": "Динамика запасов золота категорий А+В+С 1 в коренных и россыпных месторождениях в 2002–2015 гг., %"
      }
    ],
    "dataProvider": [
      {
...
function modalCreate(id) {
  console.log(id);
  var html = '<div id="' + id + '" style="width: 100%; height: 500px; background-color:#FFFFFF; "></div>'
